...
// Traduz o deck (nasceu p/ devs) para PLATEIA CRUA de saúde: overrides de roteiro sem
// jargão, exemplos de clínica, agenda própria (com a Parte 2), "regra da clínica" (dado de
// paciente na IA), intervalo, timebox na prática e slide de materiais.
...
const conceitoStack = naval("conceito_stack", { variant: "grid", eyebrow: "os personagens, sem jargão", title: "pensa num hospital", items: [
...
const passo1 = passoSlide("passo1_rls", "ao vivo · passo 1 · o banco",
  "crio uma tabela de PACIENTES e ligo a regra 'cada um só vê o que é dele'",
  "sem isso, qualquer um lê o registro de todo mundo",
  "tento ver o registro de OUTRO paciente e o sistema me barra");
...
const praticaAnalise = naval("pratica_analise", { variant: "list", eyebrow: "ao vivo · passo 5 · análise", items: [
  ...
  { label: "auditar com IA", sub: "colo a PLANTA do banco no Claude — nunca o dado do paciente" },
...
const materiaisSlide = naval("materiais", { variant: "act",
  ...
  subtitle: "guias em PDF + códigos prontos", href: "/materiais-moinhos.zip", cta: "baixar tudo (.zip)",
});

const PRATICA = [intervaloSlide, praticaIntro, conceitoStack, praticaRoteiro, passo1, passo2, passo3, praticaProva, passo4, praticaAnalise];
const REPLACE: Record<string, SlideEntry> = { agenda: agendaMoinhos };
...
export const moinhosCyberEvent: EventModule = {
  ...
  scripts: {
    ...
    cover: `Fala, pessoal! Que bom ter vocês aqui, mesmo online. Combinando: dúvida, joga no chat que eu respondo nos intervalos e no fim. Essa parte é sobre segurança — como construir rápido com IA sem deixar a porta dos fundos aberta. Primeiro a teoria, o porquê e os riscos; e na parte 2 eu monto um sistema seguro AO VIVO, na tela. Bora.`,
    ...
    agenda: `Esse é o mapa. Um: por quê — o risco que você não vê. Dois: onde o dado mora, e como trancar. Três: IA e LGPD, com foco em dado de saúde. Quatro: como se proteger. E cinco, depois de um intervalo: eu monto um sistema seguro AO VIVO, na tela. Dúvida, joga no chat que eu respondo nos intervalos e no fim.`,
    historia_real: `Olha como vaza na vida real. Sexta o app entra no ar. Sábado já tem duzentos cadastros. Domingo alguém curioso abre as ferramentas do navegador e percebe que dá pra puxar a base inteira. Segunda de manhã, a lista com nome, telefone e o MOTIVO DA CONSULTA de cada pessoa tá circulando por aí. Não precisou de hacker: precisou de uma regra de acesso que faltou — daqui a pouco você vê o nome técnico dela.`,
    ...
    storage_publico: `E tem um segundo cadeado que quase todo mundo esquece: os arquivos. Se a "pasta" fica pública, qualquer um com o link baixa o exame, o documento que a pessoa subiu. A regra de ouro: pasta privada e um link temporário que vence sozinho — tipo receita com validade: passou o prazo, não abre mais.`,
    ...
    codigo_vs_supabase: `Vale separar onde cada coisa mora. No código: conferir o que o usuário digitou, guardar as senhas do sistema no servidor (nunca na tela), limitar tentativas, e não registrar dado de paciente nos logs. No banco: as regras de acesso, quem entra, backup. Cada camada faz a sua parte.`,
    ...
    ia_prompt_injection: `Se o seu app tem um assistente de IA — e no vibecoding isso é quase automático — presta atenção. É como um paciente entregar na recepção um bilhete falsificado, assinado "pelo diretor", e o atendente obedecer, porque a instrução e a conversa chegam no mesmo balcão. Com IA é igual. É o risco número 1 da lista mundial de segurança de IA. E a defesa cabe numa frase: a IA do seu app nunca pode ter mais poder do que a pessoa que fala com ela.`,
    regra_clinica: `E aqui a pergunta que eu sei que tá na cabeça de vocês: "posso jogar dado de paciente no ChatGPT?". Resposta curta: dado que identifica o paciente NÃO entra em IA pública gratuita — ou você anonimiza, tira o que identifica, ou usa uma versão com contrato de dados, a corporativa. E repara: naquele lab que eu vou mostrar, o que eu colo na IA é a PLANTA do banco, a estrutura — nunca o dado do paciente. Guarda essa regra, é a mais prática de todas.`,
    ...
    lgpd_bases_legais: `A lei tem dez justificativas pra tratar um dado. Num serviço online, três importam. Execução de contrato: o dado é necessário pra entregar o serviço. Legítimo interesse: usos esperados, como segurança e antifraude. E consentimento: o extra, o opcional. Repara: consentimento é a ÚLTIMA da fila, não a primeira — e, pra dado de saúde, quase sempre precisa dele mesmo.`,
    lgpd_exemplos_base: `Vamos aterrissar no mundo de vocês. Agendar uma consulta? Execução de contrato. Mostrar o resultado de exame no app? Tutela da saúde. Lembrete de retorno? Contrato. Marketing de um plano ou procedimento? Aí sim, consentimento. E usar prontuário pra pesquisa ou pra treinar uma IA? Precisa de base específica ou anonimizar. Percebe? Consentimento é a exceção, não a regra.`,
    lgpd_casos_reais: `Olha os números reais. A Meta levou uma multa de um bilhão e duzentos milhões de euros, por mandar dado de europeu pros Estados Unidos sem base. Mas não precisa ir longe: aqui no Brasil, no setor de vocês, em 2020 vazaram dados de mais de 200 milhões de pessoas ligados ao Ministério da Saúde, e uma planilha exposta deixou dados de milhões de pacientes de COVID abertos. Não é "no mundo dos outros" — é saúde, é aqui. E não é "vai que pega": já pega.`,
    ...
    quando_migrar: `E como saber a hora de profissionalizar? Lembra que dá pra começar no plano simples e migrar? Os sinais: o sistema fica lento com muito dado, você precisa de backup sério, o time cresce, ou você trata dado regulado — que é exatamente o caso de vocês, saúde.`,
    ...
    checklist_segunda: `Fecho com duas listas. O que VOCÊ faz amanhã, sem depender de ninguém: liga a verificação em duas etapas nas suas contas, senha forte, e um teto de gasto na conta de IA. E o que você PERGUNTA pro seu fornecedor: a regra de acesso está ligada? rodaram o verificador de segurança? auditaram com IA? Você não precisa fazer — precisa saber cobrar.`,
    ...
    passo1_rls: `Passo 1, o banco. Crio uma tabela de PACIENTES e ligo a regra "cada um só vê o que é dele". Por que importa: sem isso, qualquer um lê o registro de todo mundo. E como você sabe que deu certo? Eu tento ver o registro de OUTRO paciente e o sistema me barra. Esse é o passo mais importante.`,
    ...
    pratica_analise: `Passo 5, fechando: análise. Rodo o verificador do Supabase, que acha falha em dois minutos — e olha, eu deixei uma falha de propósito pra vocês verem ele pegando. Depois colo a PLANTA do banco no Claude e peço os furos — nunca o dado do paciente. Isso qualquer um de vocês faz. E o que levar pra casa: você não precisa configurar isso — precisa saber perguntar pro seu fornecedor se ele fez.`,
    materiais: `E pra fechar, tá tudo aqui pra vocês levarem: o guia de estudo, o passo a passo do lab e os códigos prontos, em PDF, com a cara da SobreAI — inclusive o prompt de auditoria pra colar na IA. Eu mando o link no chat. Estuda, refaz com as suas chaves, e me chama quando construir o seu. Valeu!`,
  },
};
