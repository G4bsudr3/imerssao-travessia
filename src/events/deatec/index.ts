...
// Workshop: sem fases ao vivo embutidas nem loops de iteração.
const noLivePhase = () => null;
const noIteration = () => false;

export const deatecEvent: EventModule = {
  slug: "deatec",
  name: "Segurança em IA & Automação · DEATEC",
  sectionLabel: "bloco",
  themeClass: "theme-deatec",
  contacts: {
