...
const manifest: SlideEntry[] = [
  ...
  two("lingua_da_maquina", "por que era coisa de poucos", "escrever essas instruções", "sempre exigiu falar a língua da máquina: anos de estudo."),
  ...
  two("drivethru", "o quarto nome: quando um sistema fala com outro", "API é o drive-thru", "a API é o jeito combinado de um app pedir dado a outro: cardápio fixo, resposta pela janelinha."),
  ...
  list("primeiro_pedido", "o primeiro pedido · como descrever pra IA", [
...
const scripts: Record<string, string> = {
  ...
  lingua_da_maquina: `E repara numa coisa: escrever essas instruções, programar, sempre exigiu aprender a língua da máquina. Anos de estudo, uma língua de símbolos onde uma vírgula fora do lugar quebra tudo. POR ISSO criar software sempre foi coisa de poucos, do mesmo jeito que ler era de poucos antes do Gutenberg. Guarda essa tensão, ela se resolve depois do intervalo, e é o motivo de vocês estarem aqui.`,
