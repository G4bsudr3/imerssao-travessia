...
const manifest: SlideEntry[] = [
  ...
  stat("salto_atual", "e os saltos estão cada vez mais perto", "olha o ritmo", "cada salto chega mais rápido", "você não está ESTUDANDO um salto — está DENTRO de um."),
  // ── parte 2 · a IA ──
  ...
  grid("garcons_cotidiano", "e os sistemas pedem uns aos outros o dia inteiro", [
    ...
    { label: "no vibecoding, plugar um desses é UMA FRASE", sub: "pagamento, mapa, IA — já existem prontos, é só pedir", accent: true },
  ]),
  ...
  stat("stat_antes_depois", "o tamanho do salto, em números", "o que custava…", "6 meses + equipe + R$ 100 mil", "hoje: uma pessoa, uma conversa, uma tarde."),
  ...
  list("primeiro_pedido", "o primeiro pedido · o briefing de cabeleireiro, agora valendo", [
    ...
    { label: "liste as telas principais", sub: "'tela de login, tela da agenda, tela de novo agendamento'" },
...
const scripts: Record<string, string> = {
  ...
  duas_perguntas: `Fala, pessoal! Que bom ter vocês aqui — quem tá na sala e quem tá online. Rapidinho sobre mim: eu sou o Gabriel Breda, da SobreAI, e o meu trabalho é ajudar pessoas que NÃO são técnicas a construir coisas com IA. Antes de qualquer slide, duas perguntas. Primeira: quem aqui já usou o ChatGPT? Levanta a mão — e quem tá online, manda um 'eu' no chat. Olha isso... quase todo mundo. Agora a segunda: quem aqui já CRIOU um software? Um aplicativo, um sistema, qualquer coisa. ... Pois é. Nenhuma mão. E é exatamente sobre essa distância entre as duas perguntas que é o dia de hoje. Guarda esse momento, porque daqui a duas horas eu vou refazer a segunda pergunta — e a resposta vai ser outra.`,
  ...
  corretor_biblioteca: `Agora a analogia oficial do dia. Quem aqui já mandou mensagem errada por culpa do corretor do celular? Todo mundo, né. Aquele teclado que sugere a próxima palavra em cima do que você digitou — a IA é EXATAMENTE isso. Um completador de frases. Só que, pra treinar ela, colocaram a máquina pra 'ler' praticamente tudo que a humanidade já escreveu: os livros, as enciclopédias, os sites, os fóruns — o equivalente a milhões de bibliotecas. É como uma pessoa que leu tanta receita de bolo na vida que, quando você fala 'farinha, ovos, açúcar e...', ela chuta 'leite' antes de você terminar — e acerta. A IA ficou tão absurdamente boa em adivinhar a próxima palavra que a adivinhação começou a PARECER raciocínio. E a funcionar como um. Ela não pensa como você — ela leu tanto que consegue prever o que alguém que pensa diria.`,
