...
const manifest: SlideEntry[] = [
  ...
  list("mapa_pratica", "agora, ao vivo · sem slide · o mapa da prática", [
    ...
    { label: "3. eu peço em português, na tela", sub: "e a gente vê o salão, a cozinha e o arquivo nascerem" },
...
const scripts: Record<string, string> = {
  ...
  quiz_coro: `Antes do café, olha só o quanto vocês já sabem. O slide tá aí com quem é quem: salão, cozinha, drive-thru, arquivo. E repara no que aconteceu: frontend, backend, API, banco de dados, tem gente que leva um semestre de faculdade pra ficar confortável com esses quatro nomes, e vocês entenderam os quatro numa manhã. Você agora entende, por dentro, todo aplicativo do seu celular. Promessa da parte três: cumprida. Agora, dez minutos de café pra respirar. E um pedido pra levar na cabeça durante a pausa: pensa num problema SEU, da tua rotina ou da tua empresa, que um app resolveria. Pensa mesmo, porque eu VOU perguntar quando a gente voltar, e a ideia de alguém aqui pode virar realidade na tela ainda hoje.`,
  ...
  antes_agora: `Lado a lado, pra ficar sem dúvida. Antes: anos aprendendo a língua da máquina só pra fazer a primeira tela aparecer. Depois disso, uma equipe, a pessoa do salão, a pessoa da cozinha, a pessoa do arquivo, e meses de obra. E ai de você se mudasse de ideia no meio. Agora: você descreve, olha o resultado pronto na tela, e pede o ajuste. 'Muda a cor. Tira esse botão. Põe o preço maior.' O ciclo que era de meses virou de minutos. Errar ficou barato, e quando errar é barato, experimentar vira de graça. E repara no que isso faz com o SEU papel: você deixa de ser o operário da obra, que você nunca foi, e vira o DONO do restaurante, que descreve o que quer. A IA vira a equipe de obra inteira.`,
  ...
  prompt_com_ia: `E agora o pulo do gato, presta atenção porque isso muda tudo: você NÃO precisa escrever o prompt perfeito sozinho. Antes de abrir o Lovable, abre o ChatGPT ou o Gemini e usa ele como sócio. Você cola um pedido mais ou menos assim, e esse texto vai no material de vocês: 'quero criar um app que faz tal coisa pra tal pessoa. Antes de escrever qualquer coisa, me faça todas as perguntas que você precisar pra entender o problema, o usuário, as telas, os dados e o estilo. Quando tiver informação suficiente, gere um prompt completo, em português, pronto pra eu colar no Lovable.' Aí acontece a mágica: a IA vira uma entrevistadora. Ela te pergunta o que falta, você só responde, e no fim ela te devolve o prompt inteiro, organizado, redondo. Aí sim você leva esse prompt pro Lovable. E quando for responder as perguntas dele, fala como se fosse pra um amigo leigo, sem termo técnico, que a IA entende português muito bem. É a IA te ajudando a conversar com a outra IA. Quem faz isso constrói muito melhor do que quem chega improvisando na tela.`,
  chega_de_slide: `E chegou a hora que eu mais gosto. Vocês já conhecem os personagens do restaurante e já sabem o que é vibecoding. Teoria dada. Não tem mais nada que um slide possa fazer por vocês. Agora eu abro a tela e monto um app inteiro na frente de vocês, do zero, conversando em português. Só deixa eu te mostrar o mapa rápido, pra ninguém se perder.`,
  mapa_pratica: `O mapa é esse, em quatro passos. Primeiro, uns cinco minutos de banho de loja, rápido, porque vocês já viram a ferramenta nas demos: lembra a tela? é aqui que a gente conversa, e ali o app aparece. Depois a gente escolhe UMA ideia, deste papel aqui, das que vocês me deram. Aí eu peço, em português, na tela, com vocês lendo cada palavra do meu pedido pra IA, em tempo real. E a meta final: o app NO AR, com link, antes de você ir embora, pra você abrir no seu celular e mandar no grupo da família. E um combinado honesto, porque ao vivo é ao vivo: se alguma coisa travar no meio, eu sigo em frente, estilo programa de culinária, tem bolo pronto no forno. O que não vai acontecer é a gente terminar sem app.`,
  aovivo_final: `Vocês passaram a manhã inteira entendendo COMO funciona. Agora vocês vão ver QUANTO TEMPO leva. Cronometra aí, pega o celular, abre o cronômetro, eu tô falando sério: eu quero que você tenha o número gravado no seu relógio, não na minha palavra. [este slide fica queimando na tela durante a troca, abrir o Lovable e compartilhar. quando o app estiver no ar, avance pros 2 últimos slides pra fechar] Bora construir.`,
  ...
  bloco_suavez: `Chega de vocês me verem fazer. A parte que mais importa do dia é essa: agora é com você. Todo mundo pega o celular ou o notebook, porque nos próximos minutos não é a minha ideia que vai pro ar, é a sua. Vou botar uns vinte e cinco minutos no relógio, é o nosso tempo de construir junto, e eu fico aqui do teu lado o tempo todo, ninguém vai ficar perdido.`,
  ...
  clinica_prompts: `[NÃO rode isto como bloco separado depois do lab: é a clínica que acontece DURANTE a mão na massa. Pare a sala 2 vezes no meio do trabalho e projete a tela de quem travou.] Deixa eu pegar um de vocês pra gente afiar junto, no meio do trabalho. Olha um pedido assim: 'faz um app de gestão'. Genérico demais, e a IA devolve um monstro genérico. Gestão do quê, pra quem, qual é a primeira tela? [reescrever ao vivo] Viu? Pedido específico, resultado certeiro. É essa a habilidade que vale ouro, e vocês estão treinando ela agora, na prática.`,
  armadilhas: `Antes de eu soltar vocês no mundo, três armadilhas, pra você não cair nelas amanhã sozinho. A primeira: pedir tudo de uma vez. Um parágrafo gigante com o app inteiro vira uma bagunça; peça em camadas, uma coisa de cada vez. A segunda: aceitar sem conferir. Lembra que a IA prevê, ela não sabe; ela erra com a mesma cara de certeza com que acerta, então quem revisa é você. E a terceira, a mais séria: dado sensível exposto. Se você não põe as regras certas, o cadastro de um cliente pode ficar visível pra qualquer um. E é bem aí que a gente chega no terceiro encontro: criar ficou fácil, trancar a porta direito é o assunto de lá.`,
