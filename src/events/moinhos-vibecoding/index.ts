...
const manifest: SlideEntry[] = [
  ...
  act("licao_de_casa", "sua vez · lição de casa", "constrói o teu", "essa semana, monta alguma coisa SUA no Lovable. simples, do teu jeito. e traz pro próximo encontro."),
...
const scripts: Record<string, string> = {
  ...
  licao_de_casa: `E agora, depois de ver isso nascer na tela, uma coisa importante: quem só assiste, esquece. Quem faz, aprende. Então tá aqui a sua lição de casa, e ela é séria. Essa semana, abre o Lovable e monta alguma coisa SUA. Não precisa ser grande, pelo contrário: pega uma dorzinha do teu dia a dia e faz o menor app que resolve ela. Vinte minutos. E traz pro próximo encontro, porque a gente vai partir do que VOCÊ construiu. E ó, aproveita pra refazer aquela pergunta que eu fiz no começo pra vocês mesmos: 'já criei um software?'. Essa semana a resposta vira sim.`,
