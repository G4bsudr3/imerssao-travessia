    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-8">
        ...
        <motion.h1
          ...
          className="font-display text-[clamp(7rem,18vw,9.8rem)] leading-none"
        >
          1900
        </motion.h1>
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        ...
        <motion.h1
          ...
          className="font-display text-[clamp(3.5rem,9vw,4.9rem)] leading-tight"
        >
          vieram os carros.
        </motion.h1>
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-12">
        <motion.h1
          ...
          className="font-display text-[clamp(3.5rem,9vw,4.9rem)] leading-tight text-center"
        >
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="font-display text-[clamp(3rem,7vw,4.2rem)] leading-tight text-center"
        >
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-6">
        ...
        <motion.h1
          ...
          className="font-display text-[clamp(7rem,18vw,10.5rem)] leading-none text-laranja"
        >
          ~30 mi
        </motion.h1>
        <motion.p
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.6 }}
          className="font-display text-[clamp(3rem,8vw,4.55rem)] leading-tight text-center"
        >
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-4">
        ...
        <motion.h2
          ...
          className="font-display text-[clamp(3.5rem,9vw,4.9rem)] leading-tight text-laranja text-center"
        >
          ele muda de lugar.
        </motion.h2>
        <motion.div
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="font-display text-[clamp(3rem,7.5vw,4.2rem)] leading-tight text-center"
        >
  ...
  return (
    <SlideShell>
      <div className="flex flex-col items-center gap-8">
        ...
        >
          <p className="font-display text-[clamp(2.5rem,5vw,2.8rem)] text-center leading-tight">
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="max-w-5xl font-display text-[clamp(2.5rem,6vw,3.15rem)] leading-tight text-center"
        >
    ...
    <SlideShell>
      <div className="flex max-w-5xl flex-col items-center gap-12 text-center">
        <motion.p
          ...
          className="font-display text-[clamp(2rem,4.5vw,2.45rem)] leading-snug text-preto/75"
        >
        ...
        <motion.p
          ...
          className="font-display text-[clamp(2.5rem,5.5vw,3.15rem)] leading-tight"
        >
        ...
        <motion.p
          ...
          className="font-display text-[clamp(3rem,6.5vw,3.85rem)] leading-tight text-laranja"
        >
    ...
    <SlideShell>
      <div className="flex max-w-5xl flex-col items-center gap-10 text-center">
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          className="font-display text-[clamp(2rem,4.5vw,2.45rem)] leading-snug text-preto/65"
        >
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8, delay: 0.8, ease: "easeOut" }}
          className="font-display text-[clamp(3rem,7vw,4.2rem)] leading-tight text-laranja"
        >
    ...
    <SlideShell>
      <div className="flex flex-col items-center gap-10">
        ...
        <motion.p
          ...
          className="font-display text-[clamp(2rem,4vw,2.45rem)] text-laranja"
        >
          eu escolhi voar.
        </motion.p>
      </div>
