    ...
    <SlideShell align="start">
      <div className="grid w-full grid-cols-1 items-center gap-12 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <h1 className="font-display text-[clamp(3.5rem,9cqw,9rem)] leading-[0.92]">
            tinha mais
            <br />
    ...
    <SlideShell>
      <div className="space-y-2 text-center">
        <motion.h1
          ...
          className="font-display text-[clamp(5rem,15cqw,15rem)] leading-[0.85]"
        >
          oposição
        </motion.h1>
        <motion.h1
          ...
          className="font-display text-[clamp(5rem,15cqw,15rem)] leading-[0.85] text-laranja"
        >
          clareza
        </motion.h1>
        <motion.p
      ...
      <div className="space-y-8 text-center">
        ...
        <div className="space-y-4">
          <motion.div
            ...
            className="font-display text-[clamp(4rem,12cqw,12rem)] leading-none"
          >
            salário
          </motion.div>
          <motion.div
  ...
  return (
    <SlideShell>
      <div className="space-y-8 text-center">
        ...
        <h1 className="font-display text-[clamp(3rem,9cqw,9rem)] leading-none">
